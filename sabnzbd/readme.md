...
1. Download the [script_init.bash](https://github.com/carcheky/arr-scripts/blob/main/sabnzbd/scripts_init.bash) ([Download Link](https://raw.githubusercontent.com/carcheky/arr-scripts/main/sabnzbd/scripts_init.bash)) and place it into the following folder: `/custom-cont-init.d`
...
1. Download/update your local `/config/extended.conf` file with the latest options from: [extended.conf](https://github.com/carcheky/arr-scripts/blob/main/sabnzbd/extended.conf)
...
For more details, visit the [Wiki](https://github.com/carcheky/arr-scripts/wiki)
