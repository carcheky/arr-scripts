...
curl https://raw.githubusercontent.com/carcheky/arr-scripts/main/sonarr/AutoConfig.service -o /custom-services.d/AutoConfig
echo "Done"

echo "Download AutoExtras service..."
curl https://raw.githubusercontent.com/carcheky/arr-scripts/main/sonarr/AutoExtras.service -o /custom-services.d/AutoExtras
echo "Done"

echo "Download InvalidSeriesAutoCleaner service..."
curl https://raw.githubusercontent.com/carcheky/arr-scripts/main/sonarr/InvalidSeriesAutoCleaner.service -o /custom-services.d/InvalidSeriesAutoCleaner
echo "Done"

echo "Download YoutubeSeriesDownloader service..."
curl https://raw.githubusercontent.com/carcheky/arr-scripts/main/sonarr/YoutubeSeriesDownloader.service -o /custom-services.d/YoutubeSeriesDownloader
echo "Done"

mkdir -p /config/extended
if [ ! -f /config/extended/naming.json ]; then
	echo "Download Naming script..."
	curl https://raw.githubusercontent.com/carcheky/arr-scripts/main/sonarr/naming.json -o /config/extended/naming.json 
	echo "Done"
fi
...
curl https://raw.githubusercontent.com/carcheky/arr-scripts/main/sonarr/PlexNotify.bash -o /config/extended/PlexNotify.bash 
echo "Done"

echo "Download DailySeriesEpisodeTrimmer script..."
curl https://raw.githubusercontent.com/carcheky/arr-scripts/main/sonarr/DailySeriesEpisodeTrimmer.bash -o /config/extended/DailySeriesEpisodeTrimmer.bash 
echo "Done"
...
if [ ! -f /config/extended/sma.ini ]; then
	...
	curl https://raw.githubusercontent.com/carcheky/arr-scripts/main/sonarr/sma.ini -o /config/extended/sma.ini 
	echo "Done"
fi
...
if [ ! -f /config/extended/recyclarr.yaml ]; then
	...
	curl https://raw.githubusercontent.com/carcheky/arr-scripts/main/sonarr/recyclarr.yaml -o /config/extended/recyclarr.yaml
	echo "Done"
fi

if [ ! -f /config/extended.conf ]; then
	echo "Download Extended config..."
	curl https://raw.githubusercontent.com/carcheky/arr-scripts/main/sonarr/extended.conf -o /config/extended.conf
